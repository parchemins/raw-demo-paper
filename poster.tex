...
\makeatletter
\renewcommand\Huge{\@setfontsize\Huge{230}{230}} %% big title
...
\settitle{
  ...
  \begin{tabular}{p{\TOPBLOCK\columnwidth}p{0.62\columnwidth}p{\TOPBLOCK\columnwidth}}
    ...
    \centering\bfseries\Huge\scshape\@title &
...
\begin{columns}
  ...
  \block{}{
    ...
    \begin{center}
      ...
      \hl{$P(\gamma_i) = |\llbracket tp_1 \rrbracket_G|^{-1} \prod_{i=2}^{n}
    ...
    \begin{tabular}{lll}
      $P(\gamma_1)^{-1} =|\llbracket (?x1, P641, Q3609) \rrbracket_{G_1}| \cdot$
       ...
       $|\llbracket (\textbf{D}, P361, Q27611) \rrbracket_{G_1}|$
       $= 2 \cdot 1 \cdot 1$
    \end{tabular}
    \end{small}
  }
...
\begin{columns} 
  ...
  \block{Conclusion and Future Work}{
    \hl{RAW-JENA provides S-AQP by implementing random walks on top of
