...
\begin{columns}
  ...
  \block{\huge Approximate Query Processing for SPARQL Endpoints}{
    \begin{multicols}{2}
      ...
      Sample-based approximate query processing (S-AQP) [2] has many
...
\block{Random walks for cardinality estimates and confidence with Wander~Join~[2]}{
  ...
  %
  \adjustbox{max width=0.4\columnwidth}{Figure 1: Query $Q_1$: All cycling
    races of Central America along with their respective country.}
  \hspace{7cm}
  \adjustbox{max width=0.45\columnwidth}{Figure 2: RDF Graph $G_1$: $A$, $B$,
