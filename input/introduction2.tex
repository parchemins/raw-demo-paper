...
%% as shown in the G-CARE benchmark.
...
% With an unlimited budget, \NAME eventually returns all the results
% of $Q$.

For the demonstration, we load the 1,2 billion triples Wikidata dataset \todo{Rework this last paragraph}
